...
export const DragCloseDrawerExample = ({ open, setOpen, selectedSlide }) => {
  return (
      ...
      <DragCloseDrawer open={open} setOpen={setOpen}>
        {selectedSlide ? (
          <div className="mx-auto max-w-2xl space-y-4 text-neutral-400">
            ...
            <p>{selectedSlide.overview}</p>
            <img
              src={`https://image.tmdb.org/t/p/original/${selectedSlide.poster_path}`}
              alt={selectedSlide.title || selectedSlide.name}
