...
export const DesktopSidebar = ({
  ...
  return (<>
    <motion.div
      className={cn(
        "h-full px-4 py-4 hidden  md:flex md:flex-col bg-[var(--primary-content)] w-[300px] flex-shrink-0",
        className
      )}
      animate={{
      ...
      <AnimatePresence>
        {open && (
          <motion.div
            ...
            <div
              className="absolute right-3 top-3 z-50 text-neutral-800 dark:text-neutral-200"
              onClick={() => setOpen(!open)}>
              <IconX />
            </div>
            {children}
