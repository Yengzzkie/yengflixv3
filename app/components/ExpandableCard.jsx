      ...
      <AnimatePresence>
        {active && typeof active === "object" ? (
          <div className="fixed inset-0 grid place-items-center z-[100]">
            ...
            >
              <CloseIcon className="border-red-500" />
            </motion.button>
            <motion.div
              layoutId={`card-${active.title}-${id}`}
              ref={ref}
              className="w-full max-w-[500px] h-full md:h-fit md:max-h-[90%] flex flex-col bg-[var(--primary-dark)] sm:rounded-3xl overflow-hidden"
            >
              ...
              <div>
                <div className="flex justify-between items-start p-4">
                  ...
                  <motion.a
                    ...
                    href={`/watch/${active.id}?media_type=movie&title=${selectedSlide.title}`}
      ...
      <ul className="max-w-2xl mx-auto w-full gap-4">
        {data.map((data) => (
          <motion.div
            ...
            className="p-1 flex flex-row justify-between items-center hover:bg-neutral-50 dark:hover:bg-neutral-800 rounded-xl cursor-pointer"
          >
            <div className="flex gap-4 mb-2 md:flex-row">
            ...
            <motion.button
              ...
              className="px-3 py-2 text-sm rounded-full font-bold bg-gray-100 hover:bg-green-500 hover:text-white text-black mt-0"
            >
              Watch
            </motion.button>
          </motion.div>
